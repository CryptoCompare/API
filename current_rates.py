...
try:
	...
	for key, value in json_data.items():
		for site in value:
			...
			data1.currency = key
			data1.lastHourMinBuy = 9999999999;
			data1.lastDayMinBuy = 9999999999;
			data1.lastWeekMinBuy = 9999999999;
			data1.lastMonthMinBuy = 9999999999;
			data1.lastHourMaxBuy = -1;
			data1.lastDayMaxBuy = -1;
			data1.lastWeekMaxBuy = -1;
			data1.lastMonthMaxBuy = -1;
			data1.lastHourMinSell = 9999999999;
			data1.lastDayMinSell = 9999999999;
			data1.lastWeekMinSell = 9999999999;
			data1.lastMonthMinSell = 9999999999;
