...
try:
	...
	for key, value in json_data.items():
		for site in value:
			...
			data1.currency = key
			data1.lastHourMinBuy = float(9999999999999999999);
			data1.lastDayMinBuy = float(9999999999999999999);
			data1.lastWeekMinBuy = float(9999999999999999999);
			data1.lastMonthMinBuy = float(9999999999999999999);
			data1.lastHourMaxBuy = -1;
			data1.lastDayMaxBuy = -1;
			data1.lastWeekMaxBuy = -1;
			data1.lastMonthMaxBuy = -1;
			data1.lastHourMinSell = float(9999999999999999999);
			data1.lastDayMinSell = float(9999999999999999999);
			data1.lastWeekMinSell = float(9999999999999999999);
			data1.lastMonthMinSell = float(9999999999999999999);
